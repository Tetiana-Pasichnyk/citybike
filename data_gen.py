...
# --- Station data ---
station_names = [
    "Central Station", "University Campus", "City Hall", "Riverside Park",
    "Market Square", "Tech Hub", "Old Town", "Harbor View", "Sports Arena",
    "West End", "North Gate", "Museum Quarter", "Business District",
    "Lakeside", "Airport Terminal"
]
